<template>
    <div class="root">
        <el-row :gutter="20">
            <el-col :span="12">
                ...
                <el-option label="蓝色" value="5454ff"></el-option>
                    ...
                    <el-form-item label="模板与logo">
                        <el-col :span="11">
                            <el-select v-model="form.templateUrl" placeholder="选择相应模板" clearable @change="selectChange">
                                <el-option v-for="item in templateList" :key="item.id" :label="item.name" :value="item.imgUrl"></el-option>
                            </el-select>
                        </el-col>
                        <el-col :span="11">
                ...
                <div slot="tip" class="el-upload__tip">只能上传.jpg文件</div>
                            ...
                            <el-select v-model="form.logoUrl" placeholder="选择相应Logo" clearable @change="selectChange">
                                <el-option v-for="item in logoList" :key="item.id" :label="item.name" :value="item.imgUrl"></el-option>
                            </el-select>
                        </el-col>
                    </el-form-item>
            ...
            <el-col :span="12">
                <div class="img-wrap">
                    <el-image fit="scale-down" style="width: 400px; height: 400px;" :src="imgUrl" :preview-src-list="srcList"></el-image>
                </div>
            </el-col>
        </el-row>
    </div>
