  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="username">
        ...
        <el-input id="account" ref="username" v-model="loginForm.username" placeholder="Username" name="username"
      ...
      <el-form-item prop="password">
        ...
        <el-input id="psw" :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" placeholder="Password"
    ...
    async handleLogin() {
      ...
      try {
        ...
        if (result.code === 1) {
          ...
          this.$store.commit("user/setUsername", result.data.account.username);
          window.localStorage.setItem("username", result.data.account.username);
          if (this.$route.query.redirect) {
            this.$router.replace({ path: this.$route.query.redirect });
          } else {
            this.$router.replace({ path: "/home/books" });
          }
          this.$message({
